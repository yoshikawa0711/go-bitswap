...
type Message struct {
	...
	Corresponds    []Message_Correspond    `protobuf:"bytes,5,rep,name=corresponds,proto3" json:"corresponds"`
	PendingBytes   int32                   `protobuf:"varint,6,opt,name=pendingBytes,proto3" json:"pendingBytes,omitempty"`
}
...
func (m *Message) GetCorresponds() []Message_Correspond {
	if m != nil {
		return m.Corresponds
	}
	return nil
}
...
type Message_Correspond struct {
	Original Cid `protobuf:"bytes,1,opt,name=original,proto3,customtype=Cid" json:"original"`
	Resize   Cid `protobuf:"bytes,2,opt,name=resize,proto3,customtype=Cid" json:"resize"`
}

func (m *Message_Correspond) Reset()         { *m = Message_Correspond{} }
func (m *Message_Correspond) String() string { return proto.CompactTextString(m) }
func (*Message_Correspond) ProtoMessage()    {}
func (*Message_Correspond) Descriptor() ([]byte, []int) {
	return fileDescriptor_33c57e4bae7b9afd, []int{0, 3}
}
func (m *Message_Correspond) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *Message_Correspond) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_Message_Correspond.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *Message_Correspond) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Message_Correspond.Merge(m, src)
}
func (m *Message_Correspond) XXX_Size() int {
	return m.Size()
}
func (m *Message_Correspond) XXX_DiscardUnknown() {
	xxx_messageInfo_Message_Correspond.DiscardUnknown(m)
}

var xxx_messageInfo_Message_Correspond proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*Message_Correspond)(nil), "bitswap.message.pb.Message.Correspond")
}
...
var fileDescriptor_33c57e4bae7b9afd = []byte{
	...
	,
}
...
func (m *Message) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Corresponds) > 0 {
		for iNdEx := len(m.Corresponds) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.Corresponds[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *Message_Correspond) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *Message_Correspond) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Message_Correspond) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	{
		size := m.Resize.Size()
		i -= size
		if _, err := m.Resize.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintMessage(dAtA, i, uint64(size))
	}
	...
	dAtA[i] = 0x12
	{
		...
		i -= size
		if _, err := m.Original.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintMessage(dAtA, i, uint64(size))
	}
...
func (m *Message_Correspond) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Message) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Corresponds", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Corresponds = append(m.Corresponds, Message_Correspond{})
			if err := m.Corresponds[len(m.Corresponds)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 6:
...
func (m *Message_Correspond) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: Correspond: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: Correspond: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			if err := m.Resize.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
